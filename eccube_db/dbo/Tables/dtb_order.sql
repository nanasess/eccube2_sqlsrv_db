CREATE TABLE [dbo].[dtb_order] (
    ...
    [order_temp_id]      VARCHAR (32)     NULL,
    [customer_id]        INT                NOT NULL,
    [message]            NVARCHAR (MAX)     NULL,
    [order_name01]       NVARCHAR (256)     NULL,
    [order_name02]       NVARCHAR (256)     NULL,
    [order_kana01]       NVARCHAR (256)     NULL,
    [order_kana02]       NVARCHAR (256)     NULL,
    [order_company_name] NVARCHAR (256)     NULL,
    [order_email]        NVARCHAR (256)     NULL,
    [order_tel01]        NVARCHAR (256)     NULL,
    [order_tel02]        NVARCHAR (256)     NULL,
    [order_tel03]        NVARCHAR (256)     NULL,
    [order_fax01]        NVARCHAR (256)     NULL,
    [order_fax02]        NVARCHAR (256)     NULL,
    [order_fax03]        NVARCHAR (256)     NULL,
    [order_zip01]        NVARCHAR (256)     NULL,
    [order_zip02]        NVARCHAR (256)     NULL,
    [order_zipcode]      NVARCHAR (256)     NULL,
    [order_country_id]   INT                NULL,
    [order_pref]         SMALLINT           NULL,
    [order_addr01]       NVARCHAR (256)     NULL,
    [order_addr02]       NVARCHAR (256)     NULL,
