CREATE TABLE [dbo].[dtb_customer] (
    ...
    [name01]          NVARCHAR (256)     NOT NULL,
    [name02]          NVARCHAR (256)     NOT NULL,
    ...
    [email_mobile]    NVARCHAR (256)     NULL,
    ...
    [reminder_answer] NVARCHAR (256)     NULL,
    ...
    [mobile_phone_id] NVARCHAR (256)     NULL,
