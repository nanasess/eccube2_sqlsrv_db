CREATE TABLE [dbo].[dtb_shipping] (
    ...
    [shipping_name01]       NVARCHAR (256)     NULL,
    [shipping_name02]       NVARCHAR (256)     NULL,
    [shipping_kana01]       NVARCHAR (256)     NULL,
    [shipping_kana02]       NVARCHAR (256)     NULL,
    [shipping_company_name] NVARCHAR (256)     NULL,
    [shipping_tel01]        NVARCHAR (256)     NULL,
    [shipping_tel02]        NVARCHAR (256)     NULL,
    [shipping_tel03]        NVARCHAR (256)     NULL,
    [shipping_fax01]        NVARCHAR (256)     NULL,
    [shipping_fax02]        NVARCHAR (256)     NULL,
    [shipping_fax03]        NVARCHAR (256)     NULL,
    [shipping_country_id]   INT                NULL,
    [shipping_pref]         SMALLINT           NULL,
    [shipping_zip01]        NVARCHAR (256)     NULL,
    [shipping_zip02]        NVARCHAR (256)     NULL,
    [shipping_zipcode]      NVARCHAR (256)     NULL,
    [shipping_addr01]       NVARCHAR (256)     NULL,
    [shipping_addr02]       NVARCHAR (256)     NULL,
    [time_id]               INT                NULL,
    [shipping_time]         NVARCHAR (256)     NULL,
    [shipping_num]          NVARCHAR (256)     NULL,
