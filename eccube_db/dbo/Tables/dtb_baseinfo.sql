CREATE TABLE dtb_baseinfo (
    ...
    fax02 nvarchar(256),
    fax03 nvarchar(256),
    business_hour nvarchar(256),
    law_company nvarchar(256),
    law_manager nvarchar(256),
    law_zip01 nvarchar(256),
    law_zip02 nvarchar(256),
    law_zipcode nvarchar(256),
    law_country_id int,
    law_pref smallint,
    law_addr01 nvarchar(256),
    law_addr02 nvarchar(256),
    law_tel01 nvarchar(256),
    law_tel02 nvarchar(256),
    law_tel03 nvarchar(256),
    law_fax01 nvarchar(256),
    law_fax02 nvarchar(256),
    law_fax03 nvarchar(256),
    law_email nvarchar(256),
    law_url nvarchar(256),
    ...
    email01 nvarchar(256),
    email02 nvarchar(256),
    email03 nvarchar(256),
    email04 nvarchar(256),
    free_rule numeric(9),
    shop_name nvarchar(256),
    shop_kana nvarchar(256),
    shop_name_eng nvarchar(256),
    point_rate numeric(9) NOT NULL DEFAULT 0,
    welcome_point numeric(9) NOT NULL DEFAULT 0,
    update_date datetimeoffset NOT NULL,
    top_tpl nvarchar(256),
    product_tpl nvarchar(256),
    detail_tpl nvarchar(256),
    mypage_tpl nvarchar(256),
    good_traded nvarchar(4000),
    message nvarchar(4000),
    regular_holiday_ids nvarchar(4000),
